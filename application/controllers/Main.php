...
class Main extends CI_Controller {
	...
	public function index()
	{
		...
		$data['title'] = 'Dashbor MAS AL COMP';
		...
		if (isset($_POST['cari_tanggal'])) {
			...
			if ($this->session->userdata('id_jabatan') == '1') {				
				...
				$data['jumlah_status_transaksi_diservice'] = $this->lm->getTransaksiLaporanSortStatusTransaksi($tanggal_awal, $tanggal_akhir, 'diservice')->row_array();
				...
				$data['member_sering_menservice'] = $this->lm->getMemberSeringMenservice($tanggal_awal, $tanggal_akhir)->result_array();
			...
			// selain super administrator
				...
				$data['jumlah_status_transaksi_diservice'] = $this->lm->getTransaksiLaporanSortStatusTransaksiOutletAdministrator($tanggal_awal, $tanggal_akhir, 'diservice')->row_array();
				...
				$data['member_sering_menservice'] = $this->lm->getMemberSeringMenserviceOutletAdministrator($tanggal_awal, $tanggal_akhir)->result_array();
