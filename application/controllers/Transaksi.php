...
class Transaksi extends CI_Controller {
	...
	public function index()
	{
		...
		if ($this->session->userdata('id_jabatan') == '1') {
			...
			$data['jumlah_status_transaksi_diservice'] = $this->tm->getJumlahStatusTransaksi('diservice')->row_array();
			...
			$data['jumlah_status_transaksi_diservice'] = $this->tm->getJumlahStatusTransaksiOutletAdministrator('diservice')->row_array();
