...
class Laporan_model extends CI_Model {
	...
	public function getMemberSeringMenservice($tanggal_awal, $tanggal_akhir)
	{
		$query = "SELECT *, count('transaksi.id_transaksi') as jumlah_service FROM transaksi 
		INNER JOIN user ON transaksi.id_user = user.id_user 
		INNER JOIN member ON transaksi.id_member = member.id_member 
	...
	public function getMemberSeringMenserviceOutletAdministrator($tanggal_awal, $tanggal_akhir)
	{
		$id_outlet = $this->session->userdata('id_outlet');
		$query = "SELECT *, count('transaksi.id_transaksi') as jumlah_service FROM transaksi 
		INNER JOIN user ON transaksi.id_user = user.id_user 
