        ...
        <div class="modal-content">
          <div class="modal-body px-5">
            <div class="row my-2 justify-content-center text-center">
              ...
              <div class="col-sm-3">
                <span class="text-white badge badge-warning"><i class=""></i><img width="20" src="<?= base_url('assets/img/img_properties/laptop.png'); ?>" alt="laptop"> Diservice</span>
              </div>
              <div class="col-sm-3">
            ...
            <div class="row my-2 mb-3">
              <div class="col-sm">
                ...
                <?php elseif ($detail_header_transaksi['status_transaksi'] == 'diservice'): ?>
                  <div class="progress">
            ...
            <table class="table">
              ...
              <tr>
                ...
                <?php if ($this->session->userdata('id_jabatan') !== '4'): ?>
                  <td>
                    <?php if ($detail_header_transaksi['status_transaksi'] == 'proses'): ?>
                      <a href="<?= base_url('transaksi/ubahStatusTransaksi/') . $detail_header_transaksi['id_transaksi']; ?>" class="badge badge-danger btn-status" data-status1="Proses" data-status2="Diservice"><i class="fas fa-fw fa-sync"></i> <?= ucwords(strtolower($detail_header_transaksi['status_transaksi'])); ?></a>
                    <?php elseif ($detail_header_transaksi['status_transaksi'] == 'diservice'): ?>
                      <a href="<?= base_url('transaksi/ubahStatusTransaksi/') . $detail_header_transaksi['id_transaksi']; ?>" class="text-white badge badge-warning btn-status" data-status1="Diservice" data-status2="Siap Diambil"><i class=""></i><img width="20" src="<?= base_url('assets/img/img_properties/laptop.png'); ?>" alt="laptop"> <?= ucwords(strtolower($detail_header_transaksi['status_transaksi'])); ?></a>
                    <?php elseif ($detail_header_transaksi['status_transaksi'] == 'siap diambil'): ?>
                ...
                <?php else: ?>
                  <td>
                    ...
                    <?php elseif ($detail_header_transaksi['status_transaksi'] == 'diservice'): ?>
                      <span class="text-white badge badge-warning"><i class=""></i><img width="20" src="<?= base_url('assets/img/img_properties/laptop.png'); ?>" alt=""> <?= ucwords(strtolower($detail_header_transaksi['status_transaksi'])); ?></span>
                    <?php elseif ($detail_header_transaksi['status_transaksi'] == 'siap diambil'): ?>
