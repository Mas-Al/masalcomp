...
<div class="row justify-content-center text-center my-2">
	...
	<div class="col-md m-1 px-0">
		<a href="<?= base_url('transaksi/index/' . 'diservice'); ?>" class="btn btn-warning text-white">Diservice</a> <span class="badge badge-warning text-white"><?= $jumlah_status_transaksi_diservice['diservice']; ?></span>
	</div>
	<div class="col-md m-1 px-0">
