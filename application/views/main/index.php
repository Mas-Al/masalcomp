    ...
    <div class="col-lg-3 mb-3">
        <div class="card">
          <div class="card-body bg-warning text-white text-center">
            <div class="row justify-content-center">
              <div class="col-lg my-2">
                <i class=""></i><img width="50" src="<?= base_url('assets/img/img_properties/laptop.png'); ?>" alt="qr-code">
              </div>
              <div class="col-lg my-2">
                <h1>	
                	<?php if (isset($jumlah_status_transaksi_diservice['diservice'])): ?>
			    		<?= $jumlah_status_transaksi_diservice['diservice']; ?>
		    		<?php else: ?>
		    			0
		    		<?php endif ?>
			    </h1>
						...
						<tr class="text-center">
							...
							<?php if ($this->session->userdata('id_jabatan') !== '4'): ?>
								<td>
								  <?php if ($twshi['status_transaksi'] == 'proses'): ?>
								    <a href="<?= base_url('transaksi/ubahStatusTransaksi/') . $twshi['id_transaksi']; ?>" class="badge badge-danger btn-status" data-status1="Proses" data-status2="Diservice"><i class="fas fa-fw fa-sync"></i> <?= ucwords(strtolower($twshi['status_transaksi'])); ?></a>
								  <?php elseif ($twshi['status_transaksi'] == 'diservice'): ?>
								    <a href="<?= base_url('transaksi/ubahStatusTransaksi/') . $twshi['id_transaksi']; ?>" class="text-white badge badge-warning btn-status" data-status1="Diservice" data-status2="Siap Diambil"><i class=""></i><img width="20" src="<?= base_url('assets/img/img_properties/laptop.png'); ?>" alt="laptop"><?= ucwords(strtolower($twshi['status_transaksi'])); ?></a>
							...
							<?php else: ?>
								<td>
								  ...
								  <?php elseif ($twshi['status_transaksi'] == 'diservice'): ?>
								    <span class="text-white badge badge-warning"><i class=""></i><img width="20" src="<?= base_url('assets/img/img_properties/laptop.png'); ?>" alt="qr-code"> <?= ucwords(strtolower($twshi['status_transaksi'])); ?></span>
								  <?php elseif ($twshi['status_transaksi'] == 'siap diambil'): ?>
						...
						<tr>
							...
							<?php if ($this->session->userdata('id_jabatan') !== '5'): ?>
								<td>
								  <?php if ($dt['status_transaksi'] == 'proses'): ?>
								    <a href="<?= base_url('transaksi/ubahStatusTransaksi/') . $dt['id_transaksi']; ?>" class="badge badge-danger btn-status" data-status1="Proses" data-status2="Diservice"><i class="fas fa-fw fa-sync"></i> <?= ucwords(strtolower($dt['status_transaksi'])); ?></a>
								  <?php elseif ($dt['status_transaksi'] == 'diservice'): ?>
								    <a href="<?= base_url('transaksi/ubahStatusTransaksi/') . $dt['id_transaksi']; ?>" class="text-white badge badge-warning btn-status" data-status1="Diservice" data-status2="Siap Diambil"><i class=""></i><img width="20" src="<?= base_url('assets/img/img_properties/laptop.png'); ?>" alt="laptop"> <?= ucwords(strtolower($dt['status_transaksi'])); ?></a>
							...
							<?php else: ?>
								<td>
								  ...
								  <?php elseif ($dt['status_transaksi'] == 'diservice'): ?>
								    <span class="text-white badge badge-warning"><i class=""></i><img width="20" src="<?= base_url('assets/img/img_properties/laptop.png'); ?>" alt="laptop"> <?= ucwords(strtolower($dt['status_transaksi'])); ?></span>
								  <?php elseif ($dt['status_transaksi'] == 'siap diambil'): ?>
...
<div class="row">
	<div class="col-lg bg-white shadow p-3 rounded mx-2 my-2">
		<?php if (isset($_POST['cari_tanggal'])): ?>
			<h4><i class="fas fa-fw fa-users"></i> Daftar Member Sering Menservice <?= $tanggal_awal_heading; ?> s/d <?= $tanggal_akhir_heading; ?></h5>
		<?php else: ?>
			<h4><i class="fas fa-fw fa-users"></i> Daftar Member Sering Menservice</h4>
		<?php endif ?>
		<div class="table-responsive">
			<table class="table table-striped table-bordered">
				...
				<tbody>
					<?php $i = 1; ?>
					<?php foreach ($member_sering_menservice as $msm): ?>
						<tr class="text-center">
							<td><?= $i++; ?></td>
							<td><?= $msm['nama_member']; ?></td>
							<td><?= $msm['jumlah_service']; ?></td>
						</tr>
					<?php endforeach ?>
				</tbody>
			</table>
