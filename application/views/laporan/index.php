				...
				<div class="p-4 m-1 jumlah-laporan rounded bg-success text-white">
					<div class="card text-dark">
					  ...
					  <ul class="list-group list-group-flush">
					    ...
					    <li class="list-group-item"><i class=""></i><img width="25" src="<?= base_url('assets/img/img_properties/laptop.png'); ?>" alt="laptop"> Diservice : 
					    	<strong>
					    		<?php if ($jumlah_status_transaksi_diservice == null): ?>
					    			0
					    		<?php else: ?>
