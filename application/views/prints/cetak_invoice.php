...
<div class="container border border-dark my-2 p-4 px-5 mt-4">
  <div class="row justify-content-center">
    <div class="col-2 text-left">
      <img width="100%" class="rounded" src="<?= base_url(); ?>assets/img/img_properties/MAS-AL.jpg" alt="logo">
    </div>
      ...
      <table border="0">
        ...
        <tr>
          ...
          <td>
            ...
            <?php elseif ($transaksi['status_transaksi'] == 'diservice'): ?>
  ...
  <p class="text-center mt-4 text-dark">Terima kasih sudah mempercayakan servicean Anda kepada Kami.</p>
</div>
