					...
					<?php foreach ($riwayat_transaksi as $drt): ?>
						<tr>
							...
							<td>
								...
								<?php elseif ($drt['status_transaksi'] == 'diservice'): ?>
								    <span class="text-white badge badge-warning"><i class=""></i><img width="20" src="<?= base_url('assets/img/img_properties/laptop.png'); ?>" alt="laptop"> <?= ucwords(strtolower($drt['status_transaksi'])); ?></span>
