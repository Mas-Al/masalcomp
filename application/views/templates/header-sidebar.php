		...
		<div class="wrapper">
			...
			<nav id="sidebar">
			    <div class="sidebar-header">
			    	<img class="img-fluid" src="<?= base_url('assets/img/img_properties/MAS-AL.jpg'); ?>" alt="logo">
			    </div>
			    ...
			    <ul class="list-unstyled">
			      <li>
			        <p>Hak Cipta 2020 &copy; Oleh MAS AL COMP.</p>
			      </li>
			    </ul>
			</nav>
					  ...
					  <div class="modal-dialog" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="logoutModalLabel">Keluar Aplikasi MAS AL COMP</h5>
